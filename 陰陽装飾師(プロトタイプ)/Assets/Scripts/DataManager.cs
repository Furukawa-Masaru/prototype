...
public class DataManager : MonoBehaviour
{
    ...
    public bool read_win()
    {
        return win_;
    }

    public void set_win(bool win)
    {
        win_ = win;
    }
    ...
    private void Update()
    {
        ...
        else if (SceneManager.GetActiveScene() == SceneManager.GetSceneByName("Advice"))
        {
            if (current_scene[4] == true)
            {
                gameObject.GetComponent<AudioSource>().clip = Resources.Load<AudioClip>("Sound/BGM/Advice_BGM");
                gameObject.GetComponent<AudioSource>().Play();
